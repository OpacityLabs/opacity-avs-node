...
# Root certificate
openssl req -newkey rsa:2048 -nodes -keyout fixture/tls/rootCA.key -x509 -days 365 -out fixture/tls/rootCA.crt -subj "/C=US/ST=L1/L=EigenLayer/O=Opacity/CN=OpacityNetwork"
openssl req -x509 -sha256 -new -nodes -key fixture/tls/rootCA.key -days 3650 -out fixture/tls/rootCA.pem -subj "/C=US/ST=L1/L=EigenLayer/O=Opacity/CN=OpacityNetwork"
...
openssl req -newkey rsa:2048 -nodes -days 365000 \
   ...
   -subj "/C=US/ST=L1/L=EigenLayer/O=Opacity/CN=OpacityNetwork" 
